...
<fieldset>
			<legend>
					<span><h1 class="w3-label w3-center">Edit Profile</h1></span>
			</legend>
			
<s:form action="act_edit_profile" theme="simple" method="post"
				enctype="multipart/form-data"> 
				
				<s:hidden name="user.UserID" ></s:hidden>
				<s:hidden name="user.ProfilePictureName"></s:hidden>
<!--     <h1 class="w3-label w3-center">Edit Profile</h1> -->
   <br/>
  ...
  <div class="w3-col m4">
       ...
       <table>
        ...
        <tr>
         ...
         <td><s:radio class="w3-radio" list="{'Male','Female'}" name="user.Gender" /></td>
...
<%--   <s:property value="user.ProfilePictureName" /> --%>
    <img src=<s:property value="user.ProfilePictureName" /> alt="image/img_avatar3.png" class="w3-circle w3-margin-top" width="120px" height="120px">
       <br/><br/>
