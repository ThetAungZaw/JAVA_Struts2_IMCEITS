...
<body>
	<div class="w3-container">
		<fieldset>
			<legend>
				<h1>
					<span style="color: indigo">Edit Lecture</span>
				</h1>
			</legend>


			<s:form action="lecture_edit_save" theme="simple">
				...
				<table class="w3-container">
					...
					<tr>
						...
						<s:select list="language_list" class="styled-select1"
									...
									listValue="LanguageName" value="%{lecture.language.LanguageID}" />								
					...
					<tr style="height: 50px;">
						...
						<s:select list="section_list" class="styled-select1"
									...
									listValue="SectionName" value="%{lecture.section.SectionID}" />
					...
					<tr style="height: 200px;">
					    ...
					    <td >
   							 ...
   							 <s:textarea class="code_input" id="code1" name="lecture.SampleCode"   cols="40" rows="21">   							 
   							 </s:textarea>	
    					</td>
					...
					<tr>
						<td></td>
						<td><s:submit class="w3-btn w3-indigo w3-left" name="user"
								value="Save" /></td>
					</tr>
				</table>
			</s:form>
