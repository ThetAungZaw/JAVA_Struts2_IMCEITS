...
<body>
	<div class="w3-container">
		<fieldset>
			<legend>
				<h1>
					<span class="w3-text-indigo">Correct Answer</span>
				</h1>
			</legend>



			<s:form action="answer_edit_submit" theme="simple">
				...
				<tr style= "height= 50px;">
					...
					<tr style= "height= 50px;">
						<td width="250px">Correct</td>
						<td><s:checkbox name="answer.Correct" theme="simple"/></td>						
					</tr>
