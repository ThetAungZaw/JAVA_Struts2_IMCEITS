...
<!-- 	LOGIN -->
	...
	%>
		<li class="w3-hide-small w3-right active"><a href="${login}" class="w3-hover-white"
			><i class="fa fa-sign-in"></i>&nbsp;Login</a></li>
	<%
		}else{
	%>
	<li class="w3-hide-small w3-right"><a href="${login}" class="w3-hover-white"
			><i class="fa fa-sign-in"></i>&nbsp;Login</a></li>
	<%
		}
	%>	
...
<!-- 			<div class="w3-center"> -->
<!-- 				<img src= "image/img_avatar3.png" class="w3-circle w3-margin-top" -->
<!-- 					alt="image/img_avatar3.png" width="175px" height="175px"> -->
<!-- 			</div> -->
<!-- 			<p> -->
...
<div id="navDemo" class="w3-hide w3-hide-large w3-hide-medium"
	...
	<ul class="w3-navbar w3-left-align w3-black">
		...
		<li class="w3-padding-large w3-right"><a href="${login}">LogIn</a></li>
	</ul>
</div>
